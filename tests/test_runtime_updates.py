...
class EngineTraceTests(unittest.TestCase):
    def test_group_trace_metrics(self):
        ...
        self.assertEqual(len(summaries[0]["group_orig_mrr"]), 2)
        self.assertEqual(len(summaries[0]["group_delta_mrr"]), 2)
        self.assertEqual(len(summaries[0]["group_main_rewards"]), 2)
        ...
        self.assertIn("recall_drop_penalty_mean", metrics)
        self.assertIn("anchor_hit_ratio", metrics)
        self.assertIn("recall_drop_ratio", metrics)
        ...
        self.assertIn("flat_mrr20_group_ratio", metrics)
        self.assertIn("flat_main_reward_group_ratio", metrics)
        self.assertIn("best_reward_hit_best_mrr20_ratio", metrics)
